...
considered_pats <- considered_pats[!grepl("n/a", considered_pats)]
considered_pats <- considered_pats[!is.na(considered_pats)]
...
colors_barplot <- colorRampPalette(RColorBrewer::brewer.pal(12, "Paired"))(nrow(top_gene_ids))
